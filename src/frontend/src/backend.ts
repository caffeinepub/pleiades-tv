...
export class Backend implements backendInterface {
    ...
    async getVideoCatalog(): Promise<Array<Video>> {
        if (this.processError) {
            try {
                const result = await this.actor.getVideoCatalog();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async postComment(arg0: VideoId, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async unsubscribe(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.unsubscribe();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
